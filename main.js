...
var $author$project$Main$Model = F4(
	function (figletOp, figletChars, fontList, figList) {
		return {figList: figList, figletChars: figletChars, figletOp: figletOp, fontList: fontList};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A4($author$project$Main$Model, $author$project$Main$initFigletOp, $author$project$Main$initFigletChars, $author$project$FontList$fontList, $author$project$GeneratedFigList$generatedFigList),
...
var $author$project$Main$subscriptions = function (model) {
	return $author$project$Main$receiveFiglet($author$project$Main$ReceiveFiglet);
};
...
var $author$project$Main$map2func = F2(
	function (font, fig) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
...
var $author$project$Main$view = function (model) {
	...
	var half = $elm$core$Basics$round(
		$elm$core$List$length(model.fontList) / 2);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$map, $author$project$Main$pullDownMenu, model.fontList))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value(model.figletOp.inputText),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.figletChars)
							]))
					])),
				A2(
				$elm$html$Html$h2,
				...
				_List_fromArray(
					[
						...
						A3(
							$elm$core$List$map2,
							$author$project$Main$map2func,
							A2($elm$core$List$take, half, model.fontList),
							A2($elm$core$List$take, half, model.figList))),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						A3(
							$elm$core$List$map2,
							$author$project$Main$map2func,
							A2($elm$core$List$drop, half, model.fontList),
							A2($elm$core$List$drop, half, model.figList)))
					]))
			]));
};

...
var $author$project$Main$FigletGenerator = F3(
	function (figletOp, receiveFiglet, fontList) {
		return {figletOp: figletOp, fontList: fontList, receiveFiglet: receiveFiglet};
	});
var $author$project$Main$Gallery = F4(
	function (figletOp, receiveFiglet, fontList, figList) {
		return {figList: figList, figletOp: figletOp, fontList: fontList, receiveFiglet: receiveFiglet};
	});
var $author$project$Main$Model = F2(
	function (figletGenerator, gallery) {
		return {figletGenerator: figletGenerator, gallery: gallery};
	});
var $author$project$FontList$fontList = _List_fromArray(
...
var $author$project$GeneratedFigList$generatedFigList = _List_fromArray(
...
var $author$project$Main$initFigletChars = '\n██╗    ██╗███████╗██╗      ██████╗ ██████╗ ███╗   ███╗███████╗\n██║    ██║██╔════╝██║     ██╔════╝██╔═══██╗████╗ ████║██╔════╝\n██║ █╗ ██║█████╗  ██║     ██║     ██║   ██║██╔████╔██║█████╗  \n██║███╗██║██╔══╝  ██║     ██║     ██║   ██║██║╚██╔╝██║██╔══╝  \n╚███╔███╔╝███████╗███████╗╚██████╗╚██████╔╝██║ ╚═╝ ██║███████╗\n ╚══╝╚══╝ ╚══════╝╚══════╝ ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝\n                                                              \n    ';
var $author$project$Main$FigletOp = F4(
	function (inputText, font, horizontalLayout, verticalLayout) {
		return {font: font, horizontalLayout: horizontalLayout, inputText: inputText, verticalLayout: verticalLayout};
	});
var $author$project$Main$initFigletOp = A4($author$project$Main$FigletOp, 'Welcome!', 'ANSI Shadow', 'dafault', 'dafault');
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			...
			A3($author$project$Main$FigletGenerator, $author$project$Main$initFigletOp, $author$project$Main$initFigletChars, $author$project$FontList$fontList),
			A4($author$project$Main$Gallery, $author$project$Main$initFigletOp, '', $author$project$FontList$fontList, $author$project$GeneratedFigList$generatedFigList)),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$GalleryReceiveFig = function (a) {
	return {$: 'GalleryReceiveFig', a: a};
};
var $author$project$Main$ReceiveFiglet = function (a) {
	return {$: 'ReceiveFiglet', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$receiveFiglet = _Platform_incomingPort('receiveFiglet', $elm$json$Json$Decode$string);
var $author$project$Main$receiveGalleryFig = _Platform_incomingPort('receiveGalleryFig', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$receiveFiglet($author$project$Main$ReceiveFiglet),
				$author$project$Main$receiveGalleryFig($author$project$Main$GalleryReceiveFig)
			]));
};
var $author$project$Main$NewSelect = function (a) {
	return {$: 'NewSelect', a: a};
};
...
var $author$project$Main$galleryInputFigletJS = _Platform_outgoingPort(
	'galleryInputFigletJS',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'horizontalLayout',
					$elm$json$Json$Encode$string($.horizontalLayout)),
					_Utils_Tuple2(
					'inputText',
...
var $author$project$Main$inputFigletJS = _Platform_outgoingPort(
	'inputFigletJS',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ReceiveFiglet':
				var figlet = msg.a;
				var figGen = model.figletGenerator;
				var newFigGen = _Utils_update(
					figGen,
			...
			case 'Random':
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Main$NewSelect,
						A2(
							$elm$random$Random$int,
							0,
							$elm$core$List$length($author$project$FontList$fontList))));
			default:
				var num = msg.a;
				var figletGenerator = model.figletGenerator;
				var figOp = model.figletGenerator.figletOp;
				var arrayFontList = $elm$core$Array$fromList(model.figletGenerator.fontList);
				var newFont = A2(
					$elm$core$Maybe$withDefault,
					'Standard.flf',
					A2($elm$core$Array$get, num, arrayFontList));
				var newFigOp = _Utils_update(
					figOp,
					{font: newFont});
				var newFigGen = _Utils_update(
...
var $author$project$Main$SelectFont = function (a) {
...
var $author$project$Main$figletSample = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$Click(fontName)),
							$elm$html$Html$Attributes$href('#modal')
						]),
					_List_fromArray(
						[
							A2(
...
var $author$project$Main$pullDownMenu = function (model) {
	var selectedFont = model.figletGenerator.figletOp.font;
	var fontList = model.figletGenerator.fontList;
	return A2(
		$elm$core$List$map,
		function (font) {
			return A2(
...
var $author$project$Main$view = function (model) {
	...
	var half = $elm$core$Basics$round(
		$elm$core$List$length(model.figletGenerator.fontList) / 2);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text($author$project$Main$titleFig)
							])),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('FigletGenerator')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Font'),
						...
						$author$project$Main$pullDownMenu(model)),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.figletGenerator.receiveFiglet)
							]))
					])),
				A2(
				$elm$html$Html$h2,
				...
				_List_fromArray(
					[
						...
						A3(
							$elm$core$List$map2,
							$author$project$Main$figletSample,
							A2($elm$core$List$take, half, model.gallery.fontList),
							A2($elm$core$List$take, half, model.gallery.figList))),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						A3(
							$elm$core$List$map2,
							$author$project$Main$figletSample,
							A2($elm$core$List$drop, half, model.gallery.fontList),
							A2($elm$core$List$drop, half, model.gallery.figList)))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('modal-wrapper'),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(model.gallery.receiveFiglet)
											]))
									])),
								A2(
								$elm$html$Html$a,

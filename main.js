...
var $author$project$GeneratedFigList$figlet = _List_fromArray(
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A4($author$project$Main$Model, $author$project$Main$initFigletOp, $author$project$Main$initFigletChars, $author$project$FontList$fontList, $author$project$GeneratedFigList$figlet),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('gallery')
					]),
				A2(
					$elm$core$List$map,
					function (font) {
